...
PresoModels = c( "RA_ML Model_Random","RA_Estimated_RSIHR",  "RA_DBCD_RSIHR",  "CARA_Estimated_RSIHR", "CARA_DBCD_RSIHR", "RA_Gittins_FALSE", "RA_ML Model_EpsilonGreedy")
```
...
```{r}
ggplot(data = df_summary_T2[df_summary_T2$Model %in% PresoModels,], aes(Sample_size, averageAllocatedA, color = Model), width = 200, height = 200) +geom_line()+xlab("Sample size") + ylab("Average proprtion allocated to treatment A")+ scale_y_continuous(labels = scales::percent, limits = c(labelMin, labelMax))
```
...
```{r}
ggplot(data = df_summary_T2[df_summary_T2$Model %in% PresoModels,], aes(Sample_size, averageSuccessProportion, color = Model), width = 200, height = 200) +geom_line()+xlab("Sample size") + ylab("Total success proprtion average")+ scale_y_continuous(labels = scales::percent, limits = c(labelMin, labelMax))
```
...
```{r}
ggplot(data = df_summary_T2[df_summary_T2$Model %in% PresoModels,], aes(Sample_size, ChiSq_005, color = Model), width = 200, height = 200) +geom_line()+xlab("Sample size") + 
...
```{r}
ggplot(data = df_summary_T2[df_summary_T2$Model %in% PresoModels,], aes(Sample_size, LR_test_005, color = Model), width = 200, height = 200) +geom_line()+xlab("Sample size") + 
  ylab(ylabel)+ scale_y_continuous(labels = scales::percent, limits = c(labelMin, labelMax))
```                                                                                                                                                                                 
